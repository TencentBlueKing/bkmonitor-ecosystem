...
import (
	...
	"bkmonitor-ecosystem/examples/go-examples/blank-canvas/config"
	"bkmonitor-ecosystem/examples/go-examples/blank-canvas/service"
	"bkmonitor-ecosystem/examples/go-examples/blank-canvas/service/http"
)
