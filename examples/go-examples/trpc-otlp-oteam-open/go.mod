module bk-apm/bkmonitor-ecosystem/examples/go-examples/inner/trpc-otlp-oteam

go 1.24.3

replace bk-apm/bkmonitor-ecosystem/examples/go-examples/trpc-otlp-oteam-open/greeter => ../trpc-otlp-oteam-open/greeter

require (
	bk-apm/bkmonitor-ecosystem/examples/go-examples/trpc-otlp-oteam-open/greeter v0.0.0-00010101000000-000000000000
