...
完整实现请参考 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/go-examples/trpc-agent-go/server/main.go" target="_blank">server/main.go</a> 和 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/go-examples/trpc-agent-go/server/telemetry.go" target="_blank">server/telemetry.go</a>。
...
* <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/docs/open/go/otlp/README.md" target="_blank">Go（OpenTelemetry SDK）接入</a>
