...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/logs/http/go
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/logs/http/go" target="_blank">bkmonitor-ecosystem/examples/logs/http/go</a> 中找到。
