...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/logs/sdks/python
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/logs/sdks/python" target="_blank">bkmonitor-ecosystem/examples/logs/sdks/python</a> 中找到。
