...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/metrics/sdks/go
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/metrics/sdks/go" target="_blank">bkmonitor-ecosystem/examples/metrics/sdks/go</a> 中找到。
