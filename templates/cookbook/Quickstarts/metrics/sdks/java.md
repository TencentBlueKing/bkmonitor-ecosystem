...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/metrics/sdks/java
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/metrics/sdks/java" target="_blank">bkmonitor-ecosystem/examples/metrics/sdks/java</a> 中找到。
