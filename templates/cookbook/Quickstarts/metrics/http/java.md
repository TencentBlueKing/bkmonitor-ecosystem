...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/metrics/http/java
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/metrics/http/java" target="_blank">bkmonitor-ecosystem/examples/metrics/http/java</a> 中找到。
