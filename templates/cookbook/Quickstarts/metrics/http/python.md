...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/metrics/http/python
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/metrics/http/python" target="_blank">bkmonitor-ecosystem/examples/metrics/http/python</a> 中找到。
