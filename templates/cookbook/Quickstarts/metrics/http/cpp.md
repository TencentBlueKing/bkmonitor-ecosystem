...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/metrics/http/cpp
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/metrics/http/cpp" target="_blank">bkmonitor-ecosystem/examples/metrics/http/cpp</a> 中找到。
