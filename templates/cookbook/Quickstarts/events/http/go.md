...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/events/go
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/events/go" target="_blank">bkmonitor-ecosystem/examples/events/go</a> 中找到。
