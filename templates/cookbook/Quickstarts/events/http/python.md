...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/events/python
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/events/python" target="_blank">bkmonitor-ecosystem/examples/events/python</a> 中找到。
