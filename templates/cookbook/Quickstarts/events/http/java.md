...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/events/java
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/events/java" target="_blank">bkmonitor-ecosystem/examples/events/java</a> 中找到。
