...
API_URL="{{access_config.custom.http}}"
...
* 了解 <a href="{{docs.events.http.report_bkmonitorbeat}}" target="_blank">命令行-事件（bkmonitorbeat）上报</a>。

* 了解 <a href="{{docs.events.http.report_curl}}" target="_blank">命令行-事件（HTTP）上报</a>。

* 了解 <a href="{{docs.events.http.report_python}}" target="_blank">Python-事件（HTTP）上报</a>。

* 了解 <a href="{{docs.events.http.report_java}}" target="_blank">Java-事件（HTTP）上报</a>。
...
* <a href="{{docs.events.readme.faq_no_data}}" target="_blank">自定义事件无数据</a>。
