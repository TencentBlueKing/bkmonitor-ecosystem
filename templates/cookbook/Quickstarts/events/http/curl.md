...
cd {{ECOSYSTEM_REPOSITORY_NAME}}/examples/events/curl
```
...
示例代码也可以在样例仓库 <a href="{{ECOSYSTEM_CODE_ROOT_URL}}/examples/events/curl/report_event.sh" target="_blank">bkmonitor-ecosystem/examples/events/curl</a> 中找到。
