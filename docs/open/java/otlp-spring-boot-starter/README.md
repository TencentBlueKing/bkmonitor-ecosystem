...
如果需要在程序中上报更多数据，可以获取 `Tracer`、`Meter` 对象进行补充埋点，具体请参考 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/blob/master/docs/open/java/otlp/README.md#3-使用场景" target="_blank">Java（OpenTelemetry SDK）接入「3. 使用场景」</a> 部分。
