...
如果需要在程序中埋点上报更多数据，请参考 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/blob/master/docs/open/python/otlp/README.md#3-使用场景" target="_blank">Python（OpenTelemetry SDK）接入「3. 使用场景」</a>部分。
