...
示例代码也可以在样例仓库 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/tree/master/examples/metrics/sdks/go" target="_blank">bkmonitor-ecosystem/examples/metrics/sdks/go</a> 中找到。
