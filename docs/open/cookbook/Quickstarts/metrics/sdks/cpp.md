...
* <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/blob/master/docs/open/cookbook/Term/metrics/what.md" target="_blank">什么是指标</a>
...
参考 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/blob/master/docs/open/cookbook/Quickstarts/metrics/sdks/README.md" target="_blank">自定义指标 Prometheus SDK 上报</a> 创建一个上报协议为 `Prometheus` 的自定义指标，关注创建后提供的配置项：
...
示例代码也可以在样例仓库 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/tree/master/examples/metrics/sdks/cpp" target="_blank">bkmonitor-ecosystem/examples/metrics/sdks/cpp</a> 中找到。
...
```bash
docker build -t metrics-sdk-cpp .
docker run -p 2323:2323 -e METRICS_PORT=2323 --name sdk-pull-cpp metrics-sdk-cpp
```
