...
* <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/blob/master/docs/open/cookbook/Quickstarts/events/http/README.md" target="_blank">自定义事件 HTTP 上报</a>
...
cd bkmonitor-ecosystem/examples/events/cpp
```
...
参考 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/blob/master/docs/open/cookbook/Quickstarts/events/http/README.md" target="_blank">自定义事件 HTTP 上报</a> 创建自定义事件后需关注提供的两个配置项：
...
示例代码也可以在样例仓库 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/tree/master/examples/events/cpp" target="_blank">bkmonitor-ecosystem/examples/events/cpp</a> 中找到。
