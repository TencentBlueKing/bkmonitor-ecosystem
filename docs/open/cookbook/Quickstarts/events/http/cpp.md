...
示例代码也可以在样例仓库 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/tree/main/examples/events/cpp" target="_blank">bkmonitor-ecosystem/examples/events/cpp</a> 中找到。
