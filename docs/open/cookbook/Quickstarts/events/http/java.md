...
示例代码也可以在样例仓库 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/tree/master/examples/events/java" target="_blank">bkmonitor-ecosystem/examples/events/java</a> 中找到。
