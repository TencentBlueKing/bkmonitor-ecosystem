...
示例代码也可以在样例仓库 <a href="https://github.com/TencentBlueKing/bkmonitor-ecosystem/tree/master/examples/logs/http/python" target="_blank">bkmonitor-ecosystem/examples/logs/http/python</a> 中找到。
